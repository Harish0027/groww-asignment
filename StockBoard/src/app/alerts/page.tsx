...
function AlertManager() {
  const {
    ...
    getAlertedStocks,
  } = useStockStore(); // <- use store instead of context
  ...
  const handleCreateAlert = () => {
    ...
    createPriceAlert(selectedSymbol, price, alertType === "above");
    resetForm();
  ...
  const handleStockSelect = (symbol: string) => {
    ...
    if (stock) setTargetPrice(stock.price.toFixed(2));
  };
  ...
  const getAlertStatus = (alertId: string) => {
    ...
    else return stock.price <= alert.targetPrice ? "triggered" : "pending";
  };
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Set up an alert to be notified when a stock reaches your
                  target price
                </DialogDescription>
              </DialogHeader>
